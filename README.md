# Youtube_Data_Harvesting_and_Warehousing using Python, MongoDB, SQLite and Streamlit
#### Domain : Social Media

### Problem Statement :
The problem statement is to create a Streamlit application that allows users to access and analyze data from multiple YouTube channels. Extracting data using Youtube API and storing it on MongoDB then Transforming it to a relational databaselike SQLite. For getting various info about youtube channels.
...
- After collected data for multiple channels,it is then migrated/transformed it to a structured SQLite as data warehouse.
